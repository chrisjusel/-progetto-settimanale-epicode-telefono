...
function creaPaginaChiamata() : void{
...
function creaPaginaAzzeraChiamate() : void{
    ...
    if(paginaAzzeraChiamate != null){
        ...
        apriPagina(<HTMLElement>paginaAzzeraChiamate);
        let buttonBack = document.createElement('button');
        buttonBack.innerText = 'Indietro';
...
function creaPaginaRicarica() : void{
    ...
    if(paginaRicarica != null){
        ...
        button.addEventListener('click', function(){
            let credito = parseInt((<HTMLInputElement>document.querySelector('#quantitaCredito')).value);
            if(!isNaN(credito)){
...
function apriPagina(pagina: HTMLElement) : void{
    if(pagina != null){
